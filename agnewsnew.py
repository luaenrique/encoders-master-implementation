...
for model_name in model_names:
    ...
    print(f"  - sentence_embeddings_{model_name}_agnews_test_{model_name.split('_')[-1]}.npz")
    print(f"  - sentence_embeddings_{model_name}_agnews_train_{model_name.split('_')[-1]}.npz")
