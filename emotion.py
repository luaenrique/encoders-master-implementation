...
for countDataset in range(0, len(datasets)):
    ...
    for bertModel in models:
        ...
        bertModel.store_logits(test_dataset, f"emotion_test_{bertModel.model_name.split('/')[-1]}")
        bertModel.store_embeddings_only(test_dataset, f"emotion_test_{bertModel.model_name.split('/')[-1]}")
        
        # Para o conjunto de treino
        bertModel.store_logits(train_dataset, f"emotion_train_{bertModel.model_name.split('/')[-1]}")
        bertModel.store_embeddings_only(train_dataset, f"emotion_train_{bertModel.model_name.split('/')[-1]}")
